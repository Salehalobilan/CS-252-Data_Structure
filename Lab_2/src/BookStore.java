...
public class BookStore extends Store { //Big (O) is 1
    // because the array from the class store has a constant size
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                case 1:// View Products in the store   //Big (O) is 1
                    Store1.viewProduct();
                    break;

                case 2:// Add product to your cart     //Big (O) is 1
                    Store1.viewProduct();
                ...
                case 3:// View products in your cart    //Big (O) is 1
                    Store1.customerCart.viewItems();
                    break;

                case 4:// Remove product from your cart   //Big (O) is 1
                ...
                case 5:// Search book by title       //Big (O) is 1
