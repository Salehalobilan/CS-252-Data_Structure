        ...
        while (input.hasNext()) {
            if (productCount < MAX_PRODUCTS) {
                if (fileName.equals("Beds.txt")) {
                    StoreProduct[productCount++] = new Bed(input.next(), input.next(), input.nextInt(), input.next(),
                            input.next(), input.next(), input.nextDouble());
                    bedCount++;
                } else {
                    StoreProduct[productCount++] = new Desk(input.next(), input.next(), input.nextInt(), input.next(),
